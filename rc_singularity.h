...
#define SING_CF_LOW_FD_READER 0x800
...
#define SING_ERROR_CONNECTION_LOST (0x0100 | KS_ERROR)
#define SING_ERROR_DATA_CORRUPTED (0x0200 | KS_ERROR)
#define SING_ERROR_INTERNAL (0x0300 | KS_ERROR)
#define SING_ERROR_NO_MEMORY (0x0400 | KS_ERROR)
#define SING_ERROR_NO_SET_MEMORY (0x0500 | KS_ERROR)
#define SING_ERROR_FILE_NOT_FOUND (0x0600 | KS_ERROR)
#define SING_ERROR_OUTPUT_NOT_FOUND (0x0700 | KS_ERROR)
#define SING_ERROR_IMPOSSIBLE_OPERATION (0x0800 | KS_ERROR)
#define SING_ERROR_SYNC_FAILED (0x0900 | KS_ERROR)
