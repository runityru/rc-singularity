...
// 1_1 Успешно sing_get_value_cb
// 1_2 Успешно, набор с фантомами, ключ нормальный и удаленный, ищется нормальный
// 2 Успешно sing_get_value_cb_n
// 3 Невозможный ключ
// 4 Набор удален
// 5 Коллбек не смог выделить память
// 6_1 Ключ не найден
// 6_2 Ключ не найден, набор с фантомами, ключ удален, ищется нормальный
...
// 1_1 набор с фантомами, успешно, ключ удален, ищется удаленный
// 1_2 набор с фантомами, успешно, ключ нормальный и удаленный, ищется удаленный
// 2 Набор с фантомами, ключ только нормальный, ищется удаленный
// 3 Набор без фантомов
...
// 1 Успешно sing_get_values_cb (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления)
// 2 Успешно sing_get_values_cb_n (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе с фантомами)
// 3 Набор удален
...
// 1_1 Успешно sing_get_value
// 1_2 Успешно sing_get_value, набор с фантомами, ключ нормальный и удаленный, ищется нормальный
...
// 1 Успешно sing_get_values (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления)
// 2 Успешно sing_get_values_n (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе с фантомами)
// 3 Набор удален
...
// 1 Успешно sing_get_value_simple (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления, +маленький буфер)
// 2 Успешно sing_get_value_simple_n (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе с фантомами, +маленький буфер)
// 3 Набор удален
...
// 1 Успешно sing_get_value_same (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления)
// 2 Успешно sing_get_value_simple_n (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе с фантомами)
// 3 Набор удален
...
// 1_1 Успешно sing_key_present
// 1_2 Успешно sing_key_present, набор с фантомами, ключ нормальный и удаленный, ищется нормальный
// 2 Успешно sing_key_present_n
// 3 Невозможный ключ
// 4 Набор удален
// 5_1 Ключ не найден
// 5_2 Ключ не найден, набор с фантомами, ключ удален, ищется нормальный
...
// 1 Успешно sing_keys_present (+невозможный ключ, +ключ не найден, +ключ не найден после удаления)
// 2 Успешно sing_keys_present_n (+невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе с фантомами)
// 3 Набор удален
...
// 1_1 Успешно sing_value_equal
// 1_2 Успешно sing_value_equal, набор с фантомами, ключ нормальный и удаленный, ищется нормальный
// 2 Успешно sing_value_equal_n
// 3 Невозможный ключ
// 4 Набор удален
// 5 Значение отличается
// 6_1 Ключ не найден
// 6_2 Ключ не найден, набор с фантомами, ключ удален
...
// 2 Набор с фантомами, ключ только нормальный, ищется удаленный
// 3 Набор без фантомов
// 4 Набор с фантомами, ключ удален, ищется удаленный, значение отличается
...
// 1 Успешно sing_values_equal (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления, +значение отличается)
// 2 Успешно sing_values_equal_n (+ невозможный ключ, +ключ не найден, +ключ не найден после удаления в наборе, +значение отличается)
// 3 Набор удален
